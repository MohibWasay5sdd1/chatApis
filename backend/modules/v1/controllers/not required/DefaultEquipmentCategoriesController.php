...
use api\modules\v1\models\Defaultequipmentcategories;
...
class DefaultEquipmentCategoriesController extends ActiveController
{
    ...
    {
        $model = new Defaultequipmentcategories();
         ...
         if ($model->load(Yii::$app->request->post(),'') ) {
            ...
            $model->defaultCategoryStatus='Active';
            $model->save();
            if ($model->save()) {
    ...
    {
        if (($model = Defaultequipmentcategories::findOne($id)) !== null) {
            return $model;
        }
