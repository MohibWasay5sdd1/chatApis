        ...
        public function beforeAction($action)
    {
        ...
        if (parent::beforeAction($action)) {
            ...
            if ($this->action->id == 'index'|| $this->action->id == 'update'|| 
                ...
                $this->action->id == 'share-achievement'|| $this->action->id == 'feedback-achievement'|| 
            ...
            if ($flag==1 ||  $this->action->id == 'options' || $this->action->id == 'create' || $this->action->id =='request-registration-token' || $this->action->id == 'verify-registration' || $this->action->id == 'login' || $this->action->id == 'request-password-reset' || $this->action->id == 'verify-token' || $this->action->id == 'reset-password' || $this->action->id =='search-user'
                ) {
    ...
    public function actionInvitation($id)
    {
        ...
        if ($model) {
            ...
            if($invite){
                ...
                echo json_encode(array(
                    'status'=>200,
                    'error'=>array('message'=>"User found.")),JSON_PRETTY_PRINT
                );
            } else {
                Yii::$app->response->statusCode=400;
                echo json_encode(array(
